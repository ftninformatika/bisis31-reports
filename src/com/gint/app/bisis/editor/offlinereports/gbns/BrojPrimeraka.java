...
public class BrojPrimeraka implements OfflineReport {

  public String getFileName() {
    return "BrojPrimeraka.xml";
  }
  ...
  public void handleRecord(Record rec) {
    ...
    int copyCount = rec.getSubfields("996f").size() + 
      rec.getSubfields("997f").size();
    totalCopies += copyCount;
    totalRecords++;
    if (pubType.equals("001"))
      monographs += copyCount;
  ...
  public void stop() {
    ...
    report.append("  <totalCopies>" + totalCopies + "</totalCopies>\n");
